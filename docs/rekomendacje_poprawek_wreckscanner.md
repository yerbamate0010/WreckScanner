...
Data: 2026-06-03  
Cel dokumentu: uporządkować najbliższe poprawki aplikacji WreckScanner tak, aby pojedyncza sprawa pojazdu była wiarygodna technicznie, użyteczna dla mieszkańca i trudna do zignorowania przez służby/urząd.

---

## 1. Kierunek produktu

WreckScanner powinien być nie tylko mapą wraków, ale systemem prowadzenia spraw pojazdów. Każdy pojazd powinien mieć jedną kartę sprawy, do której można dopinać kolejne dowody: ortofotomapy, zdjęcia terenowe, metadane, zgłoszenia, odpowiedzi urzędu i statusy.

Najważniejsze założenie:

> Jedno auto = jedna sprawa. Wiele osób może dodawać kolejne obserwacje, ale nie powinno powstawać wiele rozproszonych zgłoszeń dla tego samego pojazdu.
...
## 3. Struktura sprawy pojazdu

Każda sprawa powinna mieć spójny model danych:

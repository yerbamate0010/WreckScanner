    ...
    def test_create_report_package_generates_zip_and_keeps_record_without_reporter_data(self):
        with TemporaryDirectory() as tmp:
            ...
            with zipfile.ZipFile(zip_path) as archive:
                ...
                self.assertNotIn("data-report-admin-upload", report_html)
    ...
    def test_create_public_report_package_uses_clean_assets_and_token(self):
        with TemporaryDirectory() as tmp:
            ...
            with (
                ...
                zip_path, _ = public_report_package_asset(
                    "wreck_51100000_17200000", result["package_id"], "zip", token
                )
                pdf_path, _ = public_report_package_asset(
                    "wreck_51100000_17200000", result["package_id"], "pdf", token
                )

...
class ConfigModuleContractTests(unittest.TestCase):
    ...
    def test_frontend_map_sources_are_structured_and_match_slider_contract(self):
        ...
        self.assertIn("type: 'tile'", standard_source)
        self.assertIn("url: GEOPORTAL_STANDARD_WMTS_TILE_URL", standard_source)
        self.assertIn("maxNativeZoom: 19", standard_source)
        self.assertNotIn("layers: 'Raster'", standard_source)

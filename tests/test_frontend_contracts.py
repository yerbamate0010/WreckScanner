...
class FrontendCacheSettingsContractTests(unittest.TestCase):
    ...
    def test_report_package_modal_and_admin_popup_action_exist(self):
        ...
        self.assertIn("const reviewPhotosButton = adminAuthenticated", app_js)
        ...
        self.assertIn("function clearGeotiffCacheLayer()", app_js)
    ...
    def test_admin_field_photo_upload_layer_exists(self):
        ...
        self.assertIn("'fieldPhoto.addPhotosToCase': 'Add photos to vehicle case'", i18n_js)

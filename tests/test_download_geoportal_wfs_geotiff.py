...
class DownloadTifTests(unittest.TestCase):
    ...
    def test_existing_tif_is_cache_hit(self):
        result, body, headers_seen, events = self.run_case(final_tif=b"cached")
    ...
    def test_fresh_download(self):
        result, body, headers_seen, events = self.run_case(responses=[(200, b"new")])
    ...
    def test_partial_download_resumes_on_206(self):
        ...
        self.assertEqual(result.resume_from, 3)
        self.assertEqual(body, b"oldnew")
